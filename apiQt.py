...
if PySide is not None:
    ...
    from PySide.QtGui import QAbstractItemDelegate, QItemDelegate, QStyledItemDelegate

if PyQt4 is not None:
    from PyQt4 import QtCore, QtGui
    from PyQt4.QtCore import Qt, QVariant, QAbstractItemModel, QModelIndex
    from PyQt4.QtGui import QAbstractItemDelegate, QItemDelegate, QStyledItemDelegate
